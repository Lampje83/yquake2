...
HMMDEF hmm_mat4 HMM_Reflect ( hmm_vec4 plane );
HMMDEF hmm_mat4 HMM_Householder ( hmm_vec4 plane, float scale );
...
// ERIK: For reflection and cheap refraction
// Use scale = -1 for normal reflection

HINLINE hmm_mat4
HMM_Reflect ( hmm_vec4 plane ) {
	return HMM_Householder ( plane, -1 );
}

HINLINE hmm_mat4
HMM_Householder ( hmm_vec4 plane, float scale ) {
	hmm_mat4 Result;
